...
export type PredictImageMutation = {
  __typename?: 'Mutation'
  predictImage: {
    __typename?: 'PredictResult'
    status: boolean
...
export type RegistSignMutation = {
  __typename?: 'Mutation'
  registSign: {
    __typename?: 'Sign'
    id: string
...
export type MapPageInfoQuery = {
  ...
  powerRatio: { __typename?: 'PowerRatio'; green: number; red: number }
}
...
`
export type PredictImageMutationFn = Apollo.MutationFunction<
  PredictImageMutation,
  PredictImageMutationVariables
>
...
export function usePredictImageMutation(
  ...
  return Apollo.useMutation<
    PredictImageMutation,
    PredictImageMutationVariables
  >(PredictImageDocument, options)
}
export type PredictImageMutationHookResult = ReturnType<
  typeof usePredictImageMutation
>
export type PredictImageMutationResult =
  Apollo.MutationResult<PredictImageMutation>
export type PredictImageMutationOptions = Apollo.BaseMutationOptions<
  PredictImageMutation,
  PredictImageMutationVariables
>
...
`
export type RegistSignMutationFn = Apollo.MutationFunction<
  RegistSignMutation,
  RegistSignMutationVariables
>
 ...
 * });
 */
export function useRegistSignMutation(
  baseOptions?: Apollo.MutationHookOptions<
    RegistSignMutation,
    RegistSignMutationVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useMutation<RegistSignMutation, RegistSignMutationVariables>(
    RegistSignDocument,
    options
  )
}
export type RegistSignMutationHookResult = ReturnType<
  typeof useRegistSignMutation
>
export type RegistSignMutationResult = Apollo.MutationResult<RegistSignMutation>
export type RegistSignMutationOptions = Apollo.BaseMutationOptions<
  RegistSignMutation,
  RegistSignMutationVariables
>
 ...
 * });
 */
export function useMapPageInfoQuery(
  baseOptions?: Apollo.QueryHookOptions<
    MapPageInfoQuery,
    MapPageInfoQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<MapPageInfoQuery, MapPageInfoQueryVariables>(
    MapPageInfoDocument,
    options
  )
}
export function useMapPageInfoLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<MapPageInfoQuery, MapPageInfoQueryVariables>(
    MapPageInfoDocument,
    options
  )
}
export type MapPageInfoQueryHookResult = ReturnType<typeof useMapPageInfoQuery>
export type MapPageInfoLazyQueryHookResult = ReturnType<
  typeof useMapPageInfoLazyQuery
>
export type MapPageInfoQueryResult = Apollo.QueryResult<
  MapPageInfoQuery,
  MapPageInfoQueryVariables
>
